...
namespace UnitTest
{
   ...
   /// Tests for DateTime and TimeSpan classes
   TEST_CLASS(TestDateTime)
   {
      ...
      TEST_METHOD(TestTimeZoneEnumerate)
      {
         ...
         Assert::IsTrue(timeZoneList.size() > 0);

         for (size_t index = 0, maxIndex = timeZoneList.size(); index < maxIndex; index++)
         {
            TimeZone& timeZone = timeZoneList[index];

            ATLTRACE(_T("timezone %02u: %s / %s / %s"),
               index,
               timeZone.DisplayName().GetString(),
               timeZone.StandardName().GetString(),
               timeZone.DaylightName().GetString());
         }
      }
      ...
      TEST_METHOD(TestTimeZoneInDaylightSavingsTime1)
      {
         ...
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 4, 1, 0, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 5, 1, 0, 0, 0)));

         Assert::IsTrue(false == tz.IsDaylightSavingTime(DateTime(2010, 3, 28, 0, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 3, 29, 0, 0, 0)));
         ...
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 3, 29, 3, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 3, 29, 4, 0, 0)));

         Assert::IsTrue(false == tz.IsDaylightSavingTime(DateTime(2010, 3, 28, 2, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 3, 29, 2, 0, 1)));
      }
      ...
      TEST_METHOD(TestTimeZoneInDaylightSavingsTime2)
      {
         ...
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 9, 1, 0, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 10, 1, 0, 0, 0)));
         ...
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 10, 31, 0, 0, 0)));
         Assert::IsTrue(false == tz.IsDaylightSavingTime(DateTime(2010, 11, 1, 0, 0, 0)));

         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 10, 31, 1, 0, 0)));
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 10, 31, 2, 0, 0)));
         ...
         Assert::IsTrue(tz.IsDaylightSavingTime(DateTime(2010, 10, 31, 2, 59, 59)));
         Assert::IsTrue(false == tz.IsDaylightSavingTime(DateTime(2010, 10, 31, 3, 0, 0)));
      }
   };
